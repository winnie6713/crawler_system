...
FROM (select * from localserver.postcodeaddress  where road ='西内街') a 
...
on a.province = b.province and a.city = b.city and a.county = b.county
        */
        ...
        public void queryAddressRoad(List<String> RS){
            /*
            String sql = "SELECT distinct a.province,a.city,a.county,a.township,a.village, a.road,a.postcode,b.code ";
            sql = sql + "FROM (select * from localserver.postcodeaddress  where road ='" + road + "') a ";
            sql = sql + "left join (select * from localserver.county_district_code_view where code<>'' )b ";
            sql = sql + "on a.province = b.province and a.city = b.city and a.county = b.county";
            */
            String sql = "SELECT  a.road,b.code ";
            sql = sql + "FROM (select * from localserver.postcodeaddress where road<>'' ) a ";
            sql = sql + "left join (select * from localserver.county_district_code_view where code <>'')b ";
            sql = sql + "on a.province = b.province and a.city = b.city and a.county = b.county ";
        ...
        /*
        public boolean InsertBasePostCode(String postcode,String province,String city,String county,String countyroad,
                String township,String townroad,String village,String villageroad){
        boolean insertResult = false; 
        String sql = "Insert into basepostcodes (postcode,province,city,county,countyroad,township,townroad,village,villageroad) values ('";
        sql = sql + postcode+"','"+province+"','"+city+"','"+county+"','"+countyroad+"','"+township+"','"+townroad+"','"+village+"','"+villageroad +"')";
        try{
            if (dbstate == null)
                dbstate = (Statement) dbconn.createStatement();
